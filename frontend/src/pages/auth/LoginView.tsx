      ...
      <div className="w-full max-w-[440px] relative z-10 animate-in fade-in zoom-in-95 duration-700">
        <div className="bg-white/80 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(13,148,136,0.1)] border border-white p-10 md:p-12 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">Tu espacio literario</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:border-teal-500 focus:bg-white transition-all text-slate-800 text-sm font-semibold"
            ...
            <div className="flex justify-end mb-6">
              <Link to="/forgot-password" className="text-[10px] font-bold text-teal-600 hover:text-emerald-600 uppercase tracking-widest">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-slate-700 via-teal-600 to-emerald-600 text-white py-4 rounded-2xl hover:shadow-lg transition-all duration-300 font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-3"
            >
              {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <>Iniciar Sesión <ChevronRight size={16} /></>}
            </button>
          </form>
