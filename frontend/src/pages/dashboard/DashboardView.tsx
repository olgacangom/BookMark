...
export const DashboardView = () => {
  ...
  // Datos mockeados para Retos y Actividad (hasta que los tengas en Backend)
  const challenges = [
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 pb-24 md:pb-8 animate-in fade-in duration-700">
      ...
      {/* 1. Welcome Banner (Tonos Tierra de tu Mockup) */}
            ...
            <div className="space-y-4">
              {currentlyReading.map(book => (
                <div key={book.id} className="flex gap-4 p-4 rounded-3xl hover:bg-neutral-50 transition-all border border-transparent hover:border-neutral-100">
                  <div className="w-16 h-24 bg-neutral-200 rounded-xl shadow-md overflow-hidden">
                    {/* Aquí iría book.coverUrl si lo añades al backend */}
