  ...
  return (
    <div className="bg-white p-5 rounded-[2rem] border border-border flex flex-col items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group">
      ...
      <div className="w-full mb-5 flex-1">
        ...
        {user.province && (
          <div className="mt-3 flex items-center justify-center gap-1 text-[9px] text-red-600 font-bold uppercase tracking-wider bg-red-50 px-3 py-1 rounded-full w-fit mx-auto ">
            <MapPin size={9} />
            {user.province}
          </div>
        )}
