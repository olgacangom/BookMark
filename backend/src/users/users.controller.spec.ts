...
describe('UsersController', () => {
  ...
  describe('Rutas Estáticas', () => {
    it('getRequests: should call getPendingRequests with user id', async () => {
      const mockReq = { user: { id: 'uuid-1', email: 'olga@test.com' } };
    ...
    it('updateProfile: should call update...', async () => {
      const mockReq = { user: { id: 'uuid-auth', email: 'olga@test.com' } };
  ...
  describe('Rutas de Acción Social (Follow System)', () => {
    const mockReq = { user: { id: 'my-id', email: 'olga@test.com' } };
